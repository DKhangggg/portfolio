      ...
      <div className="flex flex-col lg:flex-row gap-2 justify-center flex-wrap px-1">
        <GradientCard className="min-w-[300px] lg:min-w-[600px] p-4 h-[500px] w-[600px]">
          ...
          <p className="text-lg text-white">
            Team size: 5 | Role: Mobile Developer | Github <br />
            <ul>
              <li>
                <strong className="font-bold underline">Description:</strong>
                Mobile platform for renting electric vehicles at charging
                stations with real-time tracking, booking management, and
        ...
        <GradientCard className="min-w-[300px] lg:min-w-[600px] p-4 h-[500px] w-[600px]">
          ...
          <p className="text-lg text-white">
            Team size: 2 | Role: FullStack Developer | Github <br />
            <ul>
              <li>
        ...
        <GradientCard className="min-w-[300px] lg:min-w-[600px] p-4 h-[500px] w-[600px]">
          ...
          <p className="text-lg text-white">
            Team size: 1 | Role: FullStack Developer | Github <br />
            <ul>
              <li>
                <strong className="font-bold underline">Description:</strong> A
                fullstack web platform for a full-featured e-commerce platform
                that supports product catalog, shopping cart, checkout &
                payments, order lifecycle, user accounts, and admin management.
                <br />
              </li>
              <li>
                <strong className="font-bold underline">
